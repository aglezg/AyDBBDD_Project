...
VALUES 
  ...
  ('El Misterio de la Isla Perdida','libro', 'Una novela de intriga y suspense', '2023-03-10',
   E'\\x89504e470d0a1a0a0000',
   100),
  ('Noticias del Día','materialPeriodico', 'Resumen de los eventos actuales', '2023-11-18', E'\\x89504e470d0a1a0a0096', 100),
  ('El Periódico Semanal','materialPeriodico', 'Recopilación de noticias destacadas', '2023-11-17', E'\\x89504e470d0a1a0a0025', 1100),
  ('Economía Hoy','materialPeriodico', 'Análisis financiero y económico', '2023-11-16', E'\\xABC2DE', 120),
  ('Cultura y Espectáculos','materialPeriodico', 'Lo último en arte y entretenimiento', '2023-11-15', E'\\x89504e470d0a1a0a0034', 1100),
  ('Ciencia y Tecnología','materialPeriodico', 'Avances y descubrimientos científicos', '2023-11-14', E'\\x89504e470d0a1a0a0023', 100),
  ...
  ('Interstellar','materialAudiovisual', 'Explorando el espacio profundo', '2014-11-07', E'\\x895043B70d0a1a0a0022', 100),
  ('Planet Earth II','materialAudiovisual', 'Una exploración visual de la naturaleza', '2016-11-06', E'\\x895043470A0a1a0a0022', 100),
  ('Stranger Things','materialAudiovisual', 'Aventuras sobrenaturales en los años 80', '2016-07-15', E'\\x895043460d0a1a0a0022', 100),
  ('The Shawshank Redemption','materialAudiovisual', 'La esperanza prevalece en prisión', '1994-09-23', E'\\x895053470d0a1a0a0022', 100),
  ('Blue Planet II','materialAudiovisual', 'Explorando los océanos del mundo', '2017-11-18', E'\\x892043470d0a1a0a0022', 100);
...
VALUES 
  ('99999999X', 'Tester', 'Tester', 'Tesster', '1990-05-15', 'userTester', 'M', 'psswdTester', 32, '2013-11-18 09:30:00'),
